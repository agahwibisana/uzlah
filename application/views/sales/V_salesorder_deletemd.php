<form action="<?php echo base_url().'C_salesorder/delete_md/'.$sales_order['id']; ?>" method="post">
			...
			<table class="table-striped">
				<tbody>
					...
					<?php
						...
						{
						 echo "<tr>";
						 echo "	<td><input type='text' value='".$row['inventory_id']."' name='inventory_id[]' readonly required></td>
								<td>".$row['inv_name']."</td>
